...
interface TemplatesPanelProps {
  onContextMenu: (e: React.MouseEvent, type: 'template' | 'element', item: Template) => void
}

export function TemplatesPanel({ onContextMenu }: TemplatesPanelProps) {
  ...
  const { templates, isLoading } = usePlayoutMeta(activeShowId)
          ...
          templates?.map(t => {
            ...
            return (
              <div
                ...
                onContextMenu={(e) => onContextMenu(e, 'template', t)}
                style={{
                  padding: '4px 12px',
